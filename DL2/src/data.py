...
# a) Datensatz laden -------------------------------------------------
def get_raw_dataset(root="data", split="trainval"):
    """Roher Datensatz ohne Transformationen, wird fuer die EDA (b) benoetigt."""
...
# c) Preprocessing / d) Augmentation ---------------------------------
def get_transforms(image_size=128, augmentation=False):
